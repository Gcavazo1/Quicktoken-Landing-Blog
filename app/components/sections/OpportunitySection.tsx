      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-surface p-6 rounded-lg shadow-lg flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-primary font-title">Platform Access & Deployment Fees</h3>
          ...
          <div className="bg-surface p-6 rounded-lg shadow-lg flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <h3 className="text-2xl font-semibold mb-3 text-highlight font-title">Per-Token Minting Fees (Optional)</h3>
            <p className="text-textMuted font-body">
        ...
        <p className="text-center text-textLight mt-12 text-lg font-body">
