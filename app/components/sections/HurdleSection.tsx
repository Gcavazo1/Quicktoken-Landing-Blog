  ...
  return (
    <section className="py-16 md:py-24 bg-surface"> {/* Contrasting background */}
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-textMuted mb-12 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-background p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-xl font-semibold mb-3 text-danger">Smart Contract Expertise</h3>
          ...
          <div className="bg-background p-6 rounded-lg shadow-lg text-center">
            {/* Icon Placeholder: <FaCodeBranch className="text-danger text-4xl mx-auto mb-4" /> */}
            <h3 className="text-xl font-semibold mb-3 text-danger">Full-Stack Web Development</h3>
            <p className="text-textMuted">
          ...
          <div className="bg-background p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-xl font-semibold mb-3 text-danger">Ongoing Security & Maintenance</h3>
            <p className="text-textMuted">
        ...
        <p className="text-center text-highlight mt-12 text-lg font-semibold">
