  ...
  return (
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg md:text-xl text-textMuted text-center mb-12 max-w-3xl mx-auto">
        ...
        <div className="text-center">
          ...
          <a 
            ...
            className="inline-block bg-secondary hover:bg-opacity-80 text-background font-bold py-3 px-8 rounded-lg transition duration-300"
          >
